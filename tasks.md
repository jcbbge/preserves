...
| T9 | Canvas defaults are not getting reset | Review | Design | The canvas needs to reset to 100% view and centered. it doesnt alway seem to reset when refreshing the page even after clearing localstoreage.
