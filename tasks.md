...
| T4 | Increase 'spread' of polaroid photos for both index stock images and dashboard peach images | Review | Design | Adjust the stored settings for default placements of polaroid photos. currently then are arranged in a circular pattern around the LoginComponent and DashboardNav so this is only a minor change to the default settings to increase the spread of the polaroid photos.
