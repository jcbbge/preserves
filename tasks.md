...
| T6 | Fix DashboardNav image aspect ratio cropping | Review | Design | Dashboard component image appears cropped with wide margins on left/right sides instead of displaying as full 1:1 ratio image.
